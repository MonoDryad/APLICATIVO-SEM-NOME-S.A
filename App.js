...
export default function App() {
  return (
    <View style={cadastroStyles.container}>
      ...
      <TextInput style={[cadastroStyles.insertname, cadastroStyles.inputLogin]} placeholderTextColor="#6e6e6e"  placeholder="E-mail"></TextInput>
      <TouchableOpacity><Text style={cadastroStyles.alreadyAccount}>Eu já possuo uma conta, desejo <Text style={[cadastroStyles.yellowText]}>fazer login.</Text></Text></TouchableOpacity>
